...
// https://github.com/GraphBLAS/LAGraph/blob/master/Experimental/Algorithm/LAGraph_cc_boruvka.c
...
)
{
    ...
    GrB_Monoid_new (&Min, GrB_MIN_UINT64, (uint64_t) n);
    LAGRAPH_OK(GrB_Semiring_new (&sel2ndMin, Min, GrB_SECOND_UINT64));
    GrB_Monoid_new (&Add, GrB_PLUS_UINT64, (uint64_t) 0);
